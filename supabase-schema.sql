-- ============================================================
-- LOAKIM INTEGRATED SERVICES - SUPABASE SCHEMA
-- ============================================================
...
-- ============================================================
-- 1. SERVICES TABLE (CMS-managed service offerings)
-- ============================================================
...
-- ============================================================
-- 2. CASE STUDIES TABLE (Results / portfolio items)
-- ============================================================
...
-- ============================================================
-- 3. CONSULTATIONS TABLE (Form submissions from /consult)
-- ============================================================
...
-- ============================================================
-- 4. SITE CONTENT TABLE (Editable sections for CMS)
-- ============================================================
...
-- ============================================================
-- 5. PROFILES TABLE (Extended user data for auth users)
-- ============================================================
...
-- Consultations: Public insert, Admin full access
ALTER TABLE consultations ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Anyone can submit consultations" ON consultations
  FOR INSERT WITH CHECK (true);
CREATE POLICY "Consultations viewable by authenticated users" ON consultations
