    ...
    <>
      ...
      <section className="pt-32 pb-16 relative bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <ScrollReveal>
            ...
            <h1 className="heading-xl mb-6 text-gray-900">Service Architecture</h1>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <ScrollReveal>
            <div className="flex items-center gap-4 mb-10">
              <span className="text-6xl font-bold text-loakim-lime/20">01</span>
              <div>
      ...
      <section className="py-16 bg-loakim-dark">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <ScrollReveal>
            <div className="flex items-center gap-4 mb-10">
              <span className="text-6xl font-bold text-loakim-lime/20">02</span>
              <div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <ScrollReveal>
            <div className="flex items-center gap-4 mb-10">
              <span className="text-6xl font-bold text-loakim-lime/20">03</span>
              <div>
      ...
      <section className="py-16 bg-loakim-dark">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <ScrollReveal>
            <div className="flex items-center gap-4 mb-10">
              <span className="text-6xl font-bold text-loakim-lime/20">04</span>
              <div>
      ...
      <section className="py-24 lg:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <ScrollReveal>
            <p className="section-label-dark mb-4">EM</p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {engagementModels.map((model, index) => (
              <ScrollReveal key={model.title} delay={index * 0.15}>
                <div className="p-8 bg-white border border-gray-200 rounded-2xl hover:border-loakim-lime/20 shadow-sm hover:shadow-md transition-all duration-300 h-full flex flex-col">
                  ...
                  <Link
                    to="/consult"
                    className="inline-flex items-center justify-center gap-2 w-full px-5 py-3 bg-loakim-lime text-gray-900 font-semibold rounded-lg hover:bg-loakim-limehover transition-colors text-sm"
                  >
